...
# Motivations
The objective of this document is to propose an implementation of data analysis methods based on duality diagram in python and to develop and expand my skill in python.
...
`{r} print(sessionInfo(),locale=FALSE)`
